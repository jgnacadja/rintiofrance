            ...
            <div class="md:flex md:content-center md:justify-center md:items-center">  
                <form name="form" class="md:max-w-[50%] md:px-2 " @submit.prevent="sendEmail">
                    ...
                    <div class="md:flex md:justify-between md:space-x-8 my-3"> 
                            <div class="px-2 mb-3"> 
                                <input required type="text" class="w-full md:w-80 border-2 px-3 py-1 border-zinc-700 rounded" name="nom" placeholder="Nom *" v-model="nom">
                            </div>
                            <div class="px-2 mb-3"> 
                                <input required type="text" class="w-full md:w-80 border-2 px-3 py-1 border-zinc-700 rounded" name="tel" placeholder="Téléphone mobile" v-model="tel">
                            </div> 
                    </div>
                    <div class="md:flex md:justify-between md:space-x-8 my-3"> 
                            <div class="px-2 mb-3"> 
                                <input required type="text" class="w-full md:w-80 border-2 px-3 py-1 border-zinc-700 rounded" v-model="prenoms" name="prenoms" placeholder="Prénoms *">
                            </div>
                            <div class="px-2 mb-3"> 
                                <input required type="url" class="w-full md:w-80 border-2 px-3 py-1 border-zinc-700 rounded" name="link" v-model="linkedIn" placeholder="Lien LinkedIn, Viadeo">
                            </div> 
                    </div>
                    <div class="md:flex md:justify-between md:space-x-8 my-3"> 
                            <div class="px-2 mb-3"> 
                                <input required type="email" class="w-full md:w-80 border-2 px-3 py-1 border-zinc-700 rounded" name="email" v-model="email" placeholder="Adresse email *">
                            </div>
                            <div class="px-2 mb-3"> 
                                <input required type="url" class="w-full md:w-80 border-2 px-3 py-1 border-zinc-700 rounded" name="link2" v-model="link" placeholder="http://">
                            </div> 
                    </div>
                    ...
                    <div class=" md:flex md:justify-between md:space-x-8 my-3"> 
                            <div class="px-2 mb-3"> 
                                ...
                                <input required type="text" id="metier" class="w-full md:w-80 border-2 px-3 py-1 border-zinc-700 rounded" name="metier" v-model="metier" placeholder="ex: Développeur Java">
                            </div>
                            <div class="px-2 mb-3"> 
                                <label for="ddispo" class="block">Date de disponibilité</label>
                                <input required type="date" class="w-full md:w-80 border-2 px-3 py-1 border-zinc-700 rounded" name="datedisponibilité" v-model="dateDispo" placeholder="" id="ddispo">
                            </div> 
                    </div>
                    <div class=" md:flex md:justify-between md:space-x-8 my-3"> 
                            <div class="px-2 mb-3"> 
                    ...
                    <div class=" my-3 mt-12 px-2"> 
                            ...
                            <textarea name="cmtEntP" v-model="entenduParler" id="p" cols="30" rows="10" class="w-full border-2 px-3 py-1 border-zinc-700 rounded" required>
                            </textarea>
                    </div>
